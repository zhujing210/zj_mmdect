...
"""
Compare to 9.py, modify anchor to RetinaNet mode
"""
...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            MIN_SIZES = [[32, 40, 52], [64, 81, 102]], # iou_0.5  # w/h=1/r
            MAX_SIZES = [],
            ASPECT_RATIOS = [[0.33, 1/2, 2, 3], [0.1, 0.33, 1/2, 2, 3]],
            strides = [8, 16],
            flip = False),
        bbox_coder=dict(
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/mnt/datadisk0/jingzhudata/work_dirs/dg_mb_ssd_business_9_modify_anchor_2'