...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            MAX_SIZES = [],
            ASPECT_RATIOS = [[1/2, 2], [1/2, 2], [1/2, 2], [1/2, 2]],
            _steps = [8, 16, 32, 64],
            flip = False,
            _clip = False,
...
train_pipeline = [
    ...
    dict(
        type='CutOut',
        n_holes=(0,2),
        cutout_ratio=[(0.1,0.1), (0.2,0.2), (0.4,0.4), (0.6, 0.6)],
    ),
    dict(type='Resize', img_scale=[(384, 384), (640, 640)], keep_ratio=True),
    dict(type='Normalize', **img_norm_cfg),
    dict(type='RandomFlip', flip_ratio=0.6,direction=['horizontal', 'vertical', 'diagonal']),
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=(('coco2017', 'val2017_voc.txt'),
...
resume_from = None
workflow = [('train', 1)]
work_dir = './work_dirs/dgmobilenet_voc_v1'