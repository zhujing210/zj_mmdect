...
# model settings
"""
ClassbalancedDataset + Copypaste.  55epoches
调整 copypaste 概率为 0.3， 贴一patch，一次
"""
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/mnt/datadisk0/jingzhudata/work_dirs/dg_mb_ssd_business_9py_paste_oversampling_2'
