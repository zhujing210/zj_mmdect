...
# model settings
"""
just ClassbalancedDataset.  55epoches
"""
...
# dataset settings
dataset_type = 'DGVOCDatasetTrainDms'
# TODO ignore fjs
...
test_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(type='Expand2Canvas', size=input_size, mean=img_norm_cfg['mean'], use_base=True, gray_img=True),
            dict(type='Normalize', **img_norm_cfg),
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/mnt/datadisk0/jingzhudata/work_dirs/dg_mb_ssd_business_9py_oversampling'
