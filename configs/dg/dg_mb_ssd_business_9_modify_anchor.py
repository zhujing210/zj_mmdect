...
"""
Compare to 9.py, anchor add ratio 10
"""
...
model = dict(
    ...
    bbox_head=dict(
        ...
        anchor_generator=dict(
            ...
            MAX_SIZES = [],
            ASPECT_RATIOS = [[0.33, 1/2, 2, 3, 10], [0.1, 0.33, 1/2, 2, 3, 10]],
            strides = [8, 16],
            flip = False),
        bbox_coder=dict(
...
resume_from = None
workflow = [('train', 1)]
work_dir = '/mnt/datadisk0/jingzhudata/work_dirs/dg_mb_ssd_business_9_modify_anchor'
