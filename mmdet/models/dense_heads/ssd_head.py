...
class SSDHead(AnchorHead):
    ...
    #NOTE: outs + (gt_bboxes, gt_labels, img_metas), gt_bboxes_ignore=gt_bboxes_ignore)
    ...
    def loss(self,
        ...
        Returns:
            dict[str, Tensor]: A dictionary of loss components.
        """
        # for ft in cls_scores:
        #     if not torch.isfinite(ft).all().item():
        #         print("NANANNANA,,,,", ft)
        #         assert 1==0
        ...
        # check NaN and Inf.  must all value is nan or inf
